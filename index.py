...
def upscale():
    return f'Request values: {request.values}, Request form: {request.form}, Request json: {request.json}'
    ...
    blur_intensity = int(request.values.get('blur_intensity', default=0).encode("UTF-8"))
